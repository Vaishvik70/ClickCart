  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {(formData.paymentMethod === "google_pay" || formData.paymentMethod === "paytm" || formData.paymentMethod === "paypal") && (
          <input type="text" name="upiId" placeholder="UPI ID" value={formData.upiId} onChange={handleChange} className="w-full p-2 border rounded" required />
        )}

        <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded w-full">Proceed to Pay</button>
      </form>
    </div>
  );
}
